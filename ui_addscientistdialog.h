...
public:
    ...
    QLineEdit *Input_Scientist_Nationality;
    ...
    void setupUi(QDialog *AddScientistDialog)
    {
        ...
        verticalLayout_2->addWidget(Input_Scientist_Gender);
        ...
        Input_Scientist_Nationality = new QLineEdit(AddScientistDialog);
        Input_Scientist_Nationality->setObjectName(QStringLiteral("Input_Scientist_Nationality"));

        verticalLayout_2->addWidget(Input_Scientist_Nationality);
